...
import time, random, sys, json, null, codecs, html5lib ,shutil ,threading, glob, re, string, os, requests, six, ast, pytz, wikipedia, urllib, urllib.parse, atexit, asyncio, traceback, pafy
...
#    cek = json.load(nn)
#if clientMID not in cek["info"]:
#    client.sendMessage("u4e363b3e7d396261dccf5ee4b4d374bc","Unknown Account Has Logged In")
#    quit()
#else:
#    client.sendMessage("u4e363b3e7d396261dccf5ee4b4d374bc","Bot Ready")
...
def anunanu(to,s,wait,j=''):
    try:
        if j == '':
            data = {"messages": [{"type": "image","originalContentUrl": s,"previewImageUrl": s,"sentBy":{"label":"</> J???J???","iconUrl":"https://obs.line-scdn.net/{}".format(client.getContact(clientMID).pictureStatus),"linkUrl":"line://nv/profilePopup/mid=u2b5d7c4c4bd746ce67d1d25172783821"}}]}
        else:
            data = {"messages": [{"type": "image","originalContentUrl": s,"previewImageUrl": s,"animated":True,"extension":"gif","sentBy":{"label":"</> J???J???","iconUrl":"https://obs.line-scdn.net/{}".format(client.getContact(clientMID).pictureStatus),"linkUrl":"line://nv/profilePopup/mid=u2b5d7c4c4bd746ce67d1d25172783821"}}]}
        sendCarousel(to,data)
    except Exception as e:
        print(e)
...
#====================================================================================
def kntl(to,hehe):
    data = {"messages": [{"type": "text","text": hehe,"sentBy":{"label":"</> J???J???","iconUrl":"https://obs.line-scdn.net/{}".format(client.getContact(clientMID).pictureStatus),"linkUrl":"line://nv/profilePopup/mid=u2b5d7c4c4bd746ce67d1d25172783821"}}]}
    sendCarousel(to,data)
#====================================================================================
def command(text):
    pesan = text.lower()
                ...
                if msg.contentType == 0: 
                    ...
                    for pesan in pesan.split(" # "):
                        ...
                        if pesan == 'me':
                            ...
                            c = 'line://nv/profilePopup/mid=u2b5d7c4c4bd746ce67d1d25172783821'
                        ...
                        if pesan == "speed":
                            ...
                            data = {
                                ...
                                "sentBy": {
                                    ...
                                    "linkUrl": "line://nv/profilePopup/mid=u2b5d7c4c4bd746ce67d1d25172783821"
                                }
                            }
                            sendTemplate(to,data)
                        if pesan == "spam":
...
#====================================================================================
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "imageUrl":"https://lh3.googleusercontent.com/-aYAwvJO5VYc/VSA75kcR59I/AAAAAAAABNc/rwH_mskjK8g/w480-h270-no/Crazy%2BAnime%2BGIFs5.gif",
                                            "size": "full",
                                            "action": {
                                                "type": "uri",
                                                "uri": "https://line.me/ti/p/vIDsjIRoLO"
                                            }
                                        }
                                    ]
                                }
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "imageUrl":"https://lh6.googleusercontent.com/proxy/VRadpCcZOyJDPCE2C1nLXWgXRfOC6kFHu35W9Cq3HqWOoxGYsxbhs8V97f5KIwZrzzg_l57WgMm36fi4cBXJdOB9JAey5T5naezXDnIcN1EO5O7UoB4c3JLlOd1tmxTFPx4ueYAA364DwwbVvvm-fMnG=w440-h274-nc",
                                            "size": "full",
                                            "action": {
                                                "type": "uri",
                                                "uri": "https://line.me/ti/p/vIDsjIRoLO"
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "imageUrl":"https://steamuserimages-a.akamaihd.net/ugc/957475029106585911/CD8C510B1D48E462CE4896063080414894485F4A/",
                                            "size": "full",
                                            "action": {
                                                "type": "uri",
                                                "uri": "https://line.me/ti/p/vIDsjIRoLO"
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "imageUrl":"https://lh5.googleusercontent.com/-c6eoib6AJgU/VSA7_jH7d5I/AAAAAAAABNk/63I_RFuY5ig/w400-h225-no/Crazy%2BAnime%2BGIFs7.gif",
                                            "size": "full",
                                            "action": {
                                                "type": "uri",
                                                "uri": "https://line.me/ti/p/vIDsjIRoLO"
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "thumbnailImageUrl": "https://lh3.googleusercontent.com/proxy/XzVMSRXhG1ImhNJnAoCJiQRz5JWtjXP0HFJYk_DSEHaKjDzC7gqRXjWiNCsitfGzcWTSCnAsQ8w=w384-h384-nc",
                                            "imageBackgroundColor": "#FF00F7",
                                            "title": "Game",
                                            "text": " ???????????",
                                            "defaultAction": {
                                                "type": "uri",
                                                "uri": "line://app/1623679774-k9nBDB6b?type=text&text=?????????????"
                                            },
                                            "actions": [
                                                {
                                                    "type": "uri",
                                                ...
                                                },
                                                {
                                                    "type": "uri",
                                                    "label": " ",
                                                    "uri": "http://line.me/ti/p/~james-9-9-9"                                                                
                                                },
                                            ]
                                        }
                                    ]
                            ...
                            data = {
                                ...
                                "template": {
                                    ...
                                    "columns": [
                                        {
                                            "thumbnailImageUrl": "https://data.boteater.co/storage-i768k8Ua.gif",
                                            "imageBackgroundColor": "#FF00F7",
                                            "title": "Game",
                                            "text": " ?????????????????????????",
                                            "defaultAction": {
                                                ...
                                                "contents": [
                                                  {
                                                    "contents": [
                                                      {
                                                        "url": "https://lh3.googleusercontent.com/proxy/HuTeR1Qc7-QGXuAkh80p932six6XPvGMDMwK4r9xf6K0HTVW_J8IhiWIF5TPbPNGEOFjDtt0Z0EV8RsAZ5Fp-zLJZXRBb0AYfkYzBIqhYV4zL3pNUYyv3-NvSBl3sLumsYE5oYI8K-EHMAFtorqHLd5zbssprN4VRK4=w278-h263-nc",
                                                        "type": "icon",
                                                        "size": "md"
                                                      },
                                                      {
                        ...
                        elif pesan.startswith("drawsoupletters "):
                        ...
                        elif pesan.startswith("drawstreets "):
                            sep = text.split(" ")
