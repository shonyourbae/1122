...
RfuBot=[lineMID]
Family=["u3d817018a6ecad06c37242f0daa7c4df",lineMID]
admin=['u3d817018a6ecad06c37242f0daa7c4df',lineMID]
adminMID="u3d817018a6ecad06c37242f0daa7c4df"
...
#-------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"✍꧁❖ᴛ̶ᴇ̶ᴀ̶ᴍ̶ ̶ʜ̶ᴀ̶ᴄ̶ᴋ̶ᴘ̶ʏ̶ᴍ̶❖꧂ ")
...
#-----------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"꧁❖ᴛ̶ᴇ̶ᴀ̶ᴍ̶ ̶ʜ̶ᴀ̶ᴄ̶ᴋ̶ᴘ̶ʏ̶ᴍ̶❖꧂ " +datetime.today().strftime('%H:%M:%S')+ "™") 
...
#==============================================================================#
                    ...
                    if msg.to in RfuCctv['point']:
                        ...
                        line.sendContact(to,"u3d817018a6ecad06c37242f0daa7c4df") 
...
#                    line.sendMessage(msg.to, None, contentMetadata={"STKID":"51626516","STKPKGID":"11538","STKVER":"1"}, contentType=7)
            if settings ["Api"] == True:
                if msg.text in ["ออน"]:
                    line.sendText(msg.to,"🍭꧁❖ᴛ̶ᴇ̶ᴀ̶ᴍ̶ ̶ʜ̶ᴀ̶ᴄ̶ᴋ̶ᴘ̶ʏ̶ᴍ̶❖꧂🍭")
#            if settings ["Api"] == True:
