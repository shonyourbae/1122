...
def backupData():
    try:
        ...
        client.sendMessage("ud9e397d5fd279364ab1783c82b017c50",str(e))
        return False
            ...
            try:
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if text.lower() == 'เข้าเปิด':
                        if msg._from in "ud9e397d5fd279364ab1783c82b017c50":
                    ...
                    if text.lower() == "." and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                    ...
                    if text.lower().startswith('# ') and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                    ...
                    if text.lower() == "renew" and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                try:
                    ...
                    if text.lower().startswith('addsb ') and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                    ...
                    if text.lower().startswith('delsb') and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                sep = text.split(" ")
                    ...
                    if text.lower() == 'user' and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                    ...
                    if text.lower() == "ออกจากระบบ":
                              if sender in wait['info']:
                                ...
                                sendMention(to, ' 「 เกิดข้อผิดพลาด 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "ud9e397d5fd279364ab1783c82b017c50"])
                                        ...
                                        if wait["name"][us]["pay"] <= time.time():
                                            ...
                                            try:
                                                def kentod():
                                                    ...
                                                    os.system('screen -r {} -X stuff "cd {} && python3 modnew.py \n"'.format(us, us))
                                                    contact = client.getContact(sender)
                    ...
                    if text.lower() == "ล็อคอิน7":
                            ...
                            if text.lower() == 'addme' and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                try:
                            ...
                            if text.lower() == "loginbye" and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                client.leaveGroup(to)

                            if text.lower().startswith('ต่ออายุ ') and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if cmd == 'runtime'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                runtime = time.time() - programStart
                                client.sendMessage(to,format_timespan(runtime))

                            if cmd == 'Jam on'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                if xxxs["clock"] == True:
                            ...
                            if cmd == 'Jam off'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                if xxxs["clock"] == False:
                                    client.sendMessage(msg.to,"already off")
                                else:
                                    xxxs["clock"] = False
                                    client.sendMessage(msg.to,"done")
                            if cmd == 'up'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                if xxxs["clock"] == True:
                                    now2 = datetime.now()
                            ...
                            if cmd == 'grouplist'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                            ...
                            if text.lower() == 'rname'and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                sendMention(to, "@!", [clientMid])

                            if cmd.startswith('joinme '):
                              if sender in ["ud9e397d5fd279364ab1783c82b017c50"]:
                               text = msg.text.split()
                               number = text[1]
                               if number.isdigit():
                            ...
                            if cmd.startswith('unsend') and sender in ['ud9e397d5fd279364ab1783c82b017c50']:
                                try:
                                    args = text.split(' ')
                                    mes = 0
                                    try:
