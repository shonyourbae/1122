...
client = LINE('EEHPd4PJK3BNCKQoajac.ODOAOGxwmq4jO78qoozqNa.nUEybPzyJxa/0b2X5jpOsuIhwcM2We5aSDN6NB5FLRg=',appName='WIN10\t5.5.5\tHelloWorld5.5.5')
            ...
            try:
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if cmd == "bank" or text.lower() == "บัญชี":
                        ...
                        data = {"to": to,"messages": [{"type": "flex","altText": "[Siam Commercial Bank Public Company Limited]","contents": {"type": "bubble","styles": {"header": {"backgroundColor": "#f77d00"},"body": {"backgroundColor": "#a345ff"},"footer": {"backgroundColor": "#aaaaff"}},"header": {"type": "box","layout": "vertical","contents": [{"type": "text","text": "บัญชีธนาคารทหารไทย "}]},"hero": {"type": "image","url": "https://sv1.picz.in.th/images/2019/05/03/wZuyPv.jpg","size": "full","aspectRatio": "2:1","aspectMode": "cover"},"body": {"type": "box","layout": "vertical","contents": [{"type": "text","text": "ธนาคารทหารไทย\nJamnong Wantong\nเลขบัญชี 274-2-13685-2\n","size": "xl","wrap": True}]},"footer": {"type": "box","layout": "vertical","contents": [{"type": "text","text": "ธนาคารทหารไทย "}]}}}]}
                        data = json.dumps(data)
                        sendPost = _session.post(url, data=data, headers=headers)  
