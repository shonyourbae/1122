...
if lineMID not in cek["info"]:
    client.sendMessage("uf60bf27fb2c5bcecc320271cb87be0a7","Unknown Account Has Logged In 馃榿")
    quit()
else:
    client.sendMessage("uf60bf27fb2c5bcecc320271cb87be0a7","Bot Ready馃榿")
...
admin = ["u656416610cb18621ff79bb7a899eb36b"]
adminMID = "u656416610cb18621ff79bb7a899eb36b"
#ABC = [haha,hihi,ckck]
botStart = time.time()
msg_image={}
msg_video={}
...
#=====================================================
def sendMention88(to, mid, firstmessage='', lastmessage=''):
    try:
        arrData = ""
...
def anunanu(to,s,wait,j=''):
    try:
        if j == '':
            data = {"messages": [{"type": "image","originalContentUrl": s,"previewImageUrl": s,"sentBy":{"label":"{}".format(client.getContact(clientMID).displayName),"iconUrl":"https://obs.line-scdn.net/{}".format(client.getContact(clientMID).pictureStatus),"linkUrl":"line://ti/p/~tome2527"}}]}
        else:
            data = {"messages": [{"type": "image","originalContentUrl": s,"previewImageUrl": s,"animated":True,"extension":"gif","sentBy":{"label":"{}".format(client.getContact(clientMID).displayName),"iconUrl":"https://obs.line-scdn.net/{}".format(client.getContact(clientMID).pictureStatus),"linkUrl":"line://ti/p/~tome2527"}}]}
...
async def clientBot(op):
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:client.blockContact(op.param1)#findAndAddContactsByMid(op.param1)
#=====================================================================
#=====================================================================
#        if op.type == 11:
            ...
            if isValid != False:
                                ...
                                data = {
                                    ...
                                    "contents": {
                                        ...
                                        "hero": {
                                            ...
                                            "action": {
                                                "type": "uri",
                                                "uri": "line://nv/profilePopup/mid=uff1e5d45d9b250de026dd24ed15a2344"
                                            }
                                        },
                                        "body": {
                                            "type": "box",
                ...
                if msg.contentType == 0:
                    if "/ti/g/" in text.lower():
                        ...
                        if msg._from in "u656416610cb18621ff79bb7a899eb36b":
                            time.sleep(10)
                            p = client.getProfile()
                        ...
                        if msg._from in ["u656416610cb18621ff79bb7a899eb36b"] and msg.toType == 2:
                            try:
                        ...
                        data = {
                            ...
                            "template": {
                                ...
                                "columns": [{
                                    ...
                                    "action": {
                                        "type": "uri",
                                        "uri": "line://nv/profilePopup/mid=u656416610cb18621ff79bb7a899eb36b",
                                        "area": {
                                            "x": 520,
                                            "y": 0,
                                            "width": 520,
                    ...
                    if to not in chatbot["botMute"] and to not in chatbot["botOff"]:
                      for cmd in cmd.split(" & "):
                        if cmd.startswith('createnote ') or cmd == 'mentionnote':NoteCreate(to,cmd,msg)
                            ...
                            if msg.toType == 0:
                                client.generateReplyMessage(msg.id)
                                client.sendReplyMessage(msg.id, to, client.getContact(sender).displayName, contentMetadata = {'MSG_SENDER_ICON': 'http://dl.profile.line-cdn.net/'+client.getContact(to).pictureStatus, 'MSG_SENDER_NAME': client.getContact(to).displayName, 'previewUrl': 'http://dl.profile.line-cdn.net/'+client.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~tome2527', 'type': 'mt', 'subText': ""+client.getContact(sender).statusMessage, 'a-installUrl': 'https://line.me/ti/p/~ristmp4260', 'a-installUrl': ' https://line.me/ti/p/~ristmp4260', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~ristmp4260', 'i-linkUri': 'https://line.me/ti/p/~ristmp4260', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~ristmp4260'}, contentType=19)
                            else:
                                client.sendReplyMessage(msg.id, to, client.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+client.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~'+client.getProfile().userid, 'type': 'mt', 'subText': ""+client.getContact(sender).statusMessage, 'a-installUrl': 'https://line.me/ti/p/~ristmp4260', 'a-installUrl': ' https://line.me/ti/p/~ristmp4260', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~ristmp4260', 'i-linkUri': 'https://line.me/ti/p/~ristmp4260', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~ristmp4260'}, contentType=19)
                        if cmd == "คำสั่ง":
                            ...
                            dataProfile = [
                                {
                                    "type": "bubble",
                                    "styles": {
                                        "header": {"backgroundColor": "#110000"},
                                        "hero": {"backgroundColor": "#110000", "separator": True, "separatorColor": "#110000"},
                                        "footer": {"backgroundColor": "#EE0000", "separator": True, "separatorColor": "#EE0000"}
                                    },
                                    "header": {
                                        "type": "box",
                                        "layout": "vertical",
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "type": "image",
                                                "url": "https://sv1.picz.in.th/images/2019/01/31/Tttuig.jpg",
                                                "size": "full"
                                            },
                                            {
                                                "type": "text",
                                                "text": "ช่วยเหลือพี้นฐาน 1 :",
                                                "size": "lg",
                                                "weight": "bold",
                                                "align": "center",
                                                "color": "#98F5FF"
            ...
            #                                        {
             #                                           "type": "icon",
              #                                          #"url": 'https://pngimage.net/wp-content/uploads/2018/05/bendera-indonesia-bulat-png.ico',
               #                                         "url": 'https://pngimage.net/wp-content/uploads/2018/06/green-v-png-2.png.ico',
                #                                        "size": "md"
                  #                                  },
                  #                                  {
                   #                                     "type": "text",
                      ...
                      #                              },
                        ...
                        if cmd.startswith('cek mention ') or cmd == 'mentionme':cekmentions(to,wait,cmd)
                            ...
                            try:
                                ...
                                mes = 1
                            M = client.getRecentMessagesV2(to, 100)
                            MId = []
                            ...
                            try:
                                ...
                                comma = days.find(",")
                                days = days[:comma]
                                khietag = "u656416610cb18621ff79bb7a899eb36b"
...
#                                client.sendMessage(msg.to,"• PROTECTION •\n\n- Protect Url :\n"+ma+"\n- Protect Kick :\n"+mb+"\n- Protect Join :\n"+md+"\n- Protect Invite :\n"+me+"\nTotal「%s」Protect" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectinvite))))
                        ...
                        if cmd == "sp":
                            ...
                            sendTemplate(to,data)
                        elif cmd == "เริ่มใหม่" and sender == clientMID:
                            try:
...
#=====================================================================
 ...
 #                               client.sendMessage(to, "「 Reject 」\n\nGroup : " + G.name)
                            ...
                            txt = "╭─「 ˢᵉˡᶠᵇᵒᵗ ᵗʰᵃⁱˡᵃⁿᵈ²⁰¹⁸  」\n├────────────\n│T̵̹̩̻̜̯̠̤̦̫̩̄͒ơ̶̡̢̱̳̱̓́̏̍̂͛̕͝͠ṁ̴̼̱͔̞̩̞̞̞̙̾̕e̴̡̦̖̰̗͎̍̈́͛̉͑͗͋͜͝b̷͕̻̘̩̘̑̈́̿̽̉̌ő̷̧̙͎̥͓̠̦̯͎̯͋͆͗̏̄̾͑͝t̷̥̩̮͕͊̌͛͗̐̇͂̑̽̚l̸̖̺̼̅̓̇͒̋̽i̷̢̗͕̲̠̱̬͉̬̐̉̅̃́͝ņ̷̃͆ẹ̸͖́̑͂̀\n├────────────"
                            #txt += "\n│ˢᵉˡᶠᵇᵒᵗ ᵗʰᵃⁱˡᵃⁿᵈ"
                            ...
                            sendTemplate(to, data)
                        elif cmd == "เช็คโปรไฟล์":
                            ret = "╭─「 ˢᵉˡᶠᵇᵒᵗ ᵗʰᵃⁱˡᵃⁿᵈ²⁰¹⁸  」\n├────────────\n│   「 Profile 」\n├────────────\n"
                            ret += "│┌•Changedp\n"
                            ret += "│├•Changedp video\n"
                        ...
                        if cmd == 'tolong':
                            ...
                            ret = "╭─「 ˢᵉˡᶠᵇᵒᵗ ᵗʰᵃⁱˡᵃⁿᵈ²⁰¹⁸  」\n├────────────\n│  「 รายการประกาศ 」\n├────────────\n"
                            ret += "│┌  • ประกาศกลุ่ม [text]\n"
                            ret += "│├  • ประกาศแชท [text]\n"
                            ret += "│├  • ประกาศรวม [text]\n"
                            ret += "│├  • ส่งเสียงกลุ่ม [text]\n"
                            ret += "│└  • ส่งเสียงแชท [text]\n"
                            ret += "├────────────\n│ 「 สิ้นสุดชุดคำสั่ง 」\n├────────────\n╰─「 ˢᵉˡᶠᵇᵒᵗ ᵗʰᵃⁱˡᵃⁿᵈ ²⁰¹⁸ 」"
                            hello = "{}".format(str(ret))
                            data = {
                                "type": "text",
...
#=====================================================================
                        ...
                        elif cmd.startswith("ประกาศกลุ่ม ") and sender == clientMID:
                            txt = removeCmd("ประกาศกลุ่ม", text)
                            groups = client.getGroupIdsJoined()
                            for group in groups:
                                client.sendMessage(group, "「 Group Broadcast 」\n\n{}".format(str(txt)))
                                time.sleep(1)
                            client.sendMessage(to, "Succes broadcast to {} group".format(str(len(groups))))
                        elif cmd.startswith("ประกาศแชท ") and sender == clientMID:
                            txt = removeCmd("ประกาศแชท", text)
                            friends = client.getAllContactIds()
                            for friend in friends:
                                client.sendMessage(friend, "「 Friend Broadcast 」\n\n{}".format(str(txt)))
                                time.sleep(1)
                            client.sendMessage(to, "Succes friend cast to {} friend ".format(str(len(friends))))
                        elif cmd.startswith("ประกาศรวม ") and sender == clientMID:
                            txt = removeCmd("ประกาศรวม", text)
                            friends = client.getAllContactIds()
                            groups = client.getGroupIdsJoined()
                            for group in groups:
                                client.sendMessage(group, "「 Group Broadcast 」\n\n{}".format(str(txt)))
                            ...
                            try:
                                ...
                                client.sendMessage(to, str(error))
                        elif cmd.startswith("ส่งเสียงกลุ่ม ") and sender == clientMID:
                                bctxt = removeCmd("ส่งเสียงกลุ่ม", text)
                                bc = ("Broadcast voice")
                                cb = (bctxt + bc)
                        ...
                        elif cmd.startswith("ส่งเสียงแชท ") and sender == clientMID:
                                bctxt = removeCmd("ส่งเสียงแชท", text)
                                bc = ("Broadcast voice")
                                cb = (bctxt + bc)
                                tts = gTTS(cb, lang='id', slow=False)
                                tts.save('tts.mp3')
