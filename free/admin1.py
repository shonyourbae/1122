                        	...
                        	data = {
                                        ...
                                        [
                                    {
                                            ...
                                            },
                                        {
                                            "type":"text",
                                            #"text":"{}".format(contact.statusMessage),
                                            "text":"""👉บริการให้เช่า เซิฟเวอร์ VPS JAPAN(ญี่ปุ่น)
VPS ส่งตรงจากญี่ปุ่นรับประกันความแรง
ราคาโคตรถูก
ราคาเริ่มต้นเพียง250 THB/เดือน
มีไห้เลือกหลายกลายสเปก
👏👏👏👏👏👏👏
รับติดเซลบอทเพียง 200THB/เดือน
สามารถป้องกันรันได้ 80%
มีระบบลบห้องรันออโต้หากโดนรัน
มีลูกเล่นหลากหลายอัพเดทฟังชั่นใหม่ๆทุกสัปดาห์
👏👏👏👏👏👏👏
""",                                            
                                            "size":"xxs",
                                            "wrap":True,
...
#                                client.sendMessage(msg.to,"• PROTECTION •\n\n- Protect Url :\n"+ma+"\n- Protect Kick :\n"+mb+"\n- Protect Join :\n"+md+"\n- Protect Invite :\n"+me+"\nTotal「%s」Protect" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectinvite))))
                            ...
                            client.sendMessage(to, 'กำลังดึงข้อมูลจากเซิฟเวอร์....')
