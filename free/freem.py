...
tagadd = {
    ...
    "b": "บัญชีนี้ถูกป้องกันด้วย Self Bot ริส ระบบได้บล็อคบัญชีคุณอัตโนมัติ สนใจเซลบอทติดต่อได้ครับ line://ti/p/~ristmp4260 >_<",
                            ...
                            dataProfile = [
                                {
                                    "type": "bubble",
                                    "styles": {
                                        "header": {"backgroundColor":"#E0F8E6"},
                                        "hero": {"backgroundColor": "#E0F8E6"}, #"separator": True, "separatorColor": "#333333"},
                                        "footer": {"backgroundColor": "#E0F8E6"}, #"separator": True, "separatorColor": "#333333"}
                                    },
                                    "header": {
                                        "type": "box",
                                        "layout": "vertical",
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'http://dl.profile.line-cdn.net/',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
